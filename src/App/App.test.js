...
test('When given a state, an action that is not in switch statement and a payload, appReduce should return the state unmodified', () => {
	const testArguments = [
		{ characters: [ 'Jenny' ], search: '' },
...
test('App renders a header div containg a h1 with text "Star Wars"', () => {
